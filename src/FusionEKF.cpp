...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    // Radar: sensor_type, rho_measured, phi_measured, rhodot_measured, timestamp,
    ...
    // Lidar: sensor_type, x_measured, y_measured, timestamp, x_groundtruth,
